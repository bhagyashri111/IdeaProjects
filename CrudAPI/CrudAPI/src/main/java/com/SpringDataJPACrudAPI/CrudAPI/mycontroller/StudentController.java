package com.SpringDataJPACrudAPI.CrudAPI.mycontroller;

import com.SpringDataJPACrudAPI.CrudAPI.model.Student;
import com.SpringDataJPACrudAPI.CrudAPI.repository.StudentRepository;
...
public class StudentController {
    ...
    private void updateStudent(@PathVariable("id") long stuid, @RequestBody Student
            stuObj) {
