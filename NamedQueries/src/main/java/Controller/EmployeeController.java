...
//        TypedQuery<Employee> query = session.createNamedQuery("findEmployeeByName",
//                Employee.class);
...
//public static void findEmployeeById() { SessionFactory factory = new
//        Configuration().configure().buildSessionFactory();
//    Session session = factory.openSession();
////------------ Hibernate Named Query -------------
//    TypedQuery<Object[]> query = session.createNamedQuery("getEmployeeById",
//            Object[].class);
