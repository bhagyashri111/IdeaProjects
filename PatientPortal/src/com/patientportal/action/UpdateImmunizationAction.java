...
public class UpdateImmunizationAction extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			flag = new ImmunizationServiceImpl().updateImmunization(immunizationto.getImmunizationid(), immunizationto);


			if (flag) {
				request.setAttribute("status", UtilConstants._UPDATE_IMMUNIZATION);
