...
public class DeleteMedicationAction extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			flag = new MedicationServiceImpl().deleteMedication(medicationto.getMedicationid());


			if (flag) {
				request.setAttribute("status", UtilConstants._DELETE_MEDICATION);
