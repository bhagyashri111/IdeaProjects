...
public class UpdateHealthsummaryAction extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			flag = new HealthsummaryServiceImpl().updateHealthsummary(healthsummaryto.getHealthissueid(), healthsummaryto);


			if (flag) {
				request.setAttribute("status", UtilConstants._UPDATE_HEALTHSUMMARY);
