...
public class DeleteAppointmentAction extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			flag = new AppointmentServiceImpl().deleteAppointment(appointmentto.getAppointmentid());


			if (flag) {
				request.setAttribute("status", UtilConstants._DELETE_APPOINTMENT);
				path = UtilConstants._VIEW_ALLAPPOINTMENT_ACTION;
			} else {
			...
			e.printStackTrace();
			request.setAttribute(UtilConstants._STATUS, UtilConstants._DELETE_APPOINTMENT_FAILED);
			path = UtilConstants._STATUS_PATH;
		}finally{
