...
public class AddMedicationAction extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			flag = new MedicationServiceImpl().addMedication(medicationto);


			if (flag) {
				request.setAttribute("status", UtilConstants._ADD_MEDICATION);
				path = UtilConstants._ADD_MEDICATION_JSP;
			} else {
				request.setAttribute(UtilConstants._STATUS,
						UtilConstants._ADD_MEDICATION_FAILED);
			...
			e.printStackTrace();
			request.setAttribute(UtilConstants._STATUS, UtilConstants._ADD_MEDICATION_FAILED);
			path = UtilConstants._STATUS_PATH;
		}finally{
