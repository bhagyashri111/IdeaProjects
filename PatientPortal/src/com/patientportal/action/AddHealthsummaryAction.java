...
public class AddHealthsummaryAction extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			flag = new HealthsummaryServiceImpl().addHealthsummary(healthsummaryto);


			if (flag) {
				request.setAttribute("status", UtilConstants._ADD_HEALTHSUMMARY);
				path = UtilConstants._ADD_HEALTHSUMMARY_JSP;
			} else {
				request.setAttribute(UtilConstants._STATUS,
						UtilConstants._ADD_HEALTHSUMMARY_FAILED);
			...
			e.printStackTrace();
			request.setAttribute(UtilConstants._STATUS, UtilConstants._ADD_HEALTHSUMMARY_FAILED);
			path = UtilConstants._STATUS_PATH;
		}finally{
