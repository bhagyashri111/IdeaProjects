...
public class AddInboxmailsAction extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			flag = new InboxmailsServiceImpl().addInboxmails(inboxmailsto);

			if (flag ) {
				request.setAttribute("status", UtilConstants._ADD_INBOXMAILS);
				path = UtilConstants._ADD_INBOXMAILS_JSP;
			} else {
				request.setAttribute(UtilConstants._STATUS,
						UtilConstants._ADD_INBOXMAILS_FAILED);
			...
			e.printStackTrace();
			request.setAttribute(UtilConstants._STATUS, UtilConstants._ADD_INBOXMAILS_FAILED);
			path = UtilConstants._STATUS_PATH;
		}finally{
