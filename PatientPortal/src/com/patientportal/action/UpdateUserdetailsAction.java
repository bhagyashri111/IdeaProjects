...
public class UpdateUserdetailsAction extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			flag = new UserdetailsServiceImpl().updateUserdetails(userdetailsto.getUserid(), userdetailsto);


			if (flag) {
				request.setAttribute("status", UtilConstants._UPDATE_USERDETAILS);
				path = UtilConstants._VIEW_ALLUSERDETAILS_ACTION;
			} else {
