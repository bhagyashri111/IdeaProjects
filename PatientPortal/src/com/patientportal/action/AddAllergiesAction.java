...
public class AddAllergiesAction extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			flag = new AllergiesServiceImpl().addAllergies(allergiesto);


			if (flag) {
				request.setAttribute("status", UtilConstants._ADD_ALLERGIES);
				path = UtilConstants._ADD_ALLERGIES_JSP;
			} else {
				request.setAttribute(UtilConstants._STATUS,
						UtilConstants._ADD_ALLERGIES_FAILED);
			...
			e.printStackTrace();
			request.setAttribute(UtilConstants._STATUS, UtilConstants._ADD_ALLERGIES_FAILED);
			path = UtilConstants._STATUS_PATH;
		}finally{
