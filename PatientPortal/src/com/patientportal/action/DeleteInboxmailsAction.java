...
public class DeleteInboxmailsAction extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			flag = new InboxmailsServiceImpl().deleteInboxmails(Integer.parseInt(request.getParameter("mailid")));


			if (flag) {
				request.setAttribute("status", UtilConstants._DELETE_INBOXMAILS);
