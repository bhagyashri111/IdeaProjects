...
public class UpdateAllergiesAction extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			flag = new AllergiesServiceImpl().updateAllergies(allergiesto.getAllergieid(), allergiesto);


			if (flag) {
				request.setAttribute("status", UtilConstants._UPDATE_ALLERGIES);
