...
public class AddImmunizationAction extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			flag = new ImmunizationServiceImpl().addImmunization(immunizationto);


			if (flag) {
				request.setAttribute("status", UtilConstants._ADD_IMMUNIZATION);
				path = UtilConstants._ADD_IMMUNIZATION_JSP;
			} else {
				request.setAttribute(UtilConstants._STATUS,
						UtilConstants._ADD_IMMUNIZATION_FAILED);
			...
			e.printStackTrace();
			request.setAttribute(UtilConstants._STATUS, UtilConstants._ADD_IMMUNIZATION_FAILED);
			path = UtilConstants._STATUS_PATH;
		}finally{
