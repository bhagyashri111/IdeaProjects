...
public class UpdatePrescriptionAction extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			flag = new PrescriptionServiceImpl().updatePrescription(prescriptionto.getPrescriptionid(), prescriptionto);


			if (flag) {
				request.setAttribute("status", UtilConstants._UPDATE_PRESCRIPTION);
