...
<html>
	...
	<body>
		...
		<div>
			...
			<right-body>
<form action="./UpdateTestresultsAction" method="post" name="testresults"
onsubmit='return validate()'>
<center>
	<h2>
			<font color='#sharew'>UPDATE TESTRESULTS</font>
	</h2>
	</center>
	<pre>
	<c:if  test='${testresults ne null}'>
<table align='center'>
        	<tr>
                <td align='right'>
        		Useridref :
        	...
        	<tr>
                ...
                <td align='right'>
                            <input type='text' value='${testresults.testname}' name='testname'>
                </td>
            </tr>
        	<tr>
                <td align='right'>
                ...
                <td align='right'>
                            <input type='text' value='${testresults.testdescription}' name='testdescription'>
                </td>
            </tr>
        	<tr>
                <td align='right'>
                ...
                <td align='right'>
                            <input type='text' value='${testresults.testresult}' name='testresult'>
                </td>
            </tr>
        	<tr>
                <td align='right'>
                ...
                <td align='right'>
                            <input type='text' value='${testresults.orderby}' name='orderby'>
                </td>
            </tr>
			        <tr align='center'>
                          <td>
...
var frmvalidator = new Validator("testresults");
			frmvalidator.addValidation('testid', 'req','Please enter testid');
			frmvalidator.addValidation('useridref', 'req','Please enter useridref');
			frmvalidator.addValidation('testname', 'req','Please enter testname');
			frmvalidator.addValidation('testdescription', 'req','Please enter testdescription');
			frmvalidator.addValidation('testresult', 'req','Please enter testresult');
			frmvalidator.addValidation('orderby', 'req','Please enter orderby');
			frmvalidator.addValidation('dateoftest', 'req','Please enter dateoftest');
