...
<html>
	...
	<body>
		...
		<div>
			...
			<right-body>
<form action="./UpdatePrescriptionAction" method="post" name="prescription"
onsubmit='return validate()'>
<center>
	<h2>
			<font color='#sharew'>UPDATE PRESCRIPTION</font>
	</h2>
	</center>
	<pre>
	<c:if  test='${prescription ne null}'>
<table align='center'>
        	<tr>
                <td align='right'>
        		Useridref :
        	...
        	<tr>
                ...
                <td align='right'>
                            <input type='text' value='${prescription.prescription}' name='prescription'>
                </td>
            </tr>
        	<tr>
                <td align='right'>
                ...
                <td align='right'>
                            <input type='text' value='${prescription.prescriptiondesc}' name='prescriptiondesc'>
                </td>
            </tr>
        	<tr>
                <td align='right'>
                ...
                <td align='right'>
                            <input type='text' value='${prescription.additionnalinformation}' name='additionnalinformation'>
                </td>
            </tr>
			        <tr align='center'>
                          <td>
...
var frmvalidator = new Validator("prescription");
			frmvalidator.addValidation('prescriptionid', 'req','Please enter prescriptionid');
			...
			frmvalidator.addValidation('prescriptiondesc', 'req','Please enter prescriptiondesc');
			frmvalidator.addValidation('prescriptiondate', 'req','Please enter prescriptiondate');
