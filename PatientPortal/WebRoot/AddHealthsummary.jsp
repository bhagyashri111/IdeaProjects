		...
		<table>
			...
			<tr>
				...
				<td style="padding-left: 27px;">
					...
					<br>
					<font color='blue'><b> Current Health Issues <%if(session.getAttribute("userfullname")!=null){%>of the patient <%out.println(session.getAttribute("userfullname"));} %></b> </font>
					<hr></hr>
					<form action="./AddHealthsummaryAction" method="post"
...
<table align='center'>
        	<tr style="height: 100px;">
                ...
                <td align='right'>
                            <textarea name='healthissue'
											style="height: 100px; width: 260px;"></textarea>
                </td>
            </tr>
            <tr>
							<td>
