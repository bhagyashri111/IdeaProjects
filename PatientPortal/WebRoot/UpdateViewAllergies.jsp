...
<html>
	...
	<body>
		...
		<div>
			...
			<right-body>
<form action="./UpdateAllergiesAction" method="post" name="allergies"
onsubmit='return validate()'>
<center>
	<h2>
			<font color='#sharew'>UPDATE ALLERGIES</font>
	</h2>
	</center>
	<pre>
	<c:if  test='${allergies ne null}'>
<table align='center'>
        	<tr>
                <td align='right'>
        		Useridref :
        	...
        	<tr>
                ...
                <td align='right'>
                            <input type='text' value='${allergies.allergietype}' name='allergietype'>
                </td>
            </tr>
        	<tr>
                <td align='right'>
                ...
                <td align='right'>
                            <input type='text' value='${allergies.allergiedesc}' name='allergiedesc'>
                </td>
            </tr>
        	<tr>
                <td align='right'>
                ...
                <td align='right'>
                            <input type='text' value='${allergies.allergieintruction}' name='allergieintruction'>
                </td>
            </tr>
			        <tr align='center'>
                          <td>
...
var frmvalidator = new Validator("allergies");
			frmvalidator.addValidation('allergieid', 'req','Please enter allergieid');
			...
			frmvalidator.addValidation('allergieintruction', 'req','Please enter allergieintruction');
			frmvalidator.addValidation('dateofallergie', 'req','Please enter dateofallergie');
