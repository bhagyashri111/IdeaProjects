...
<html>
	...
	<body>
		...
		<div>
			...
			<right-body>
<form action="./UpdateSentmailsAction" method="post" name="sentmails"
onsubmit='return validate()'>
<center>
	<h2>
			<font color='#sharew'>UPDATE SENTMAILS</font>
	</h2>
	</center>
	<pre>
	<c:if  test='${sentmails ne null}'>
<table align='center'>
        	<tr>
                <td align='right'>
        		Frommailidref :
        	...
        	<tr>
                ...
                <td align='right'>
                            <input type='text' value='${sent_mails.mailsub}' name='mailsub'>
                </td>
            </tr>
        	<tr>
                <td align='right'>
                ...
                <td align='right'>
                            <input type='text' value='${sent_mails.mailbody}' name='mailbody'>
                </td>
            </tr>
			        <tr align='center'>
                          <td>
