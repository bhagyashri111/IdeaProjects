		...
		<table>
			...
			<div class="menu-header">
				<h2>
					...
					Allergies <%if(session.getAttribute("userfullname")!=null){%>of the patient <%out.println(session.getAttribute("userfullname"));} %>
				</h2>
				<hr class="style"></hr>
			</div>
			<h4>
			...
			<br>
			<font color='blue'><b>Allergies</b> </font>
			<hr></hr>
			<form action='.\DeleteAllergiesAction' method='post'>
				<table width="100%">
					<tr  bgcolor="#d4d5d8" height="50px">
						...
						<td align="center">
							<b>Allergie Description</b>
						</td>
						<td align="center">
							<b>Allergie Instruction</b>
						</td>
						<td align="center">
							<b>Date </b>
						</td>
					</tr>
					<c:forEach var="allergiesTO" items="${allergiestolist}">
						<tr>
							<td  style="border-bottom: 2px; border-bottom-color: #d4d5d8; border-bottom-style: inset;">
								<input type='checkbox' name='allergieid'
									value='${allergiesTO.allergieid}'>
							</td>
							<td  style="border-bottom: 2px; border-bottom-color: #d4d5d8; border-bottom-style: inset;">
								<!--<a
									href='.\UpdateViewAllergiesAction?allergieid=${allergiesTO.allergieid}'>${allergiesTO.allergietype}</a>-->
									${allergiesTO.allergietype}
							</td>
							<td  style="border-bottom: 2px; border-bottom-color: #d4d5d8; border-bottom-style: inset;">
								${allergiesTO.allergiedesc}
							</td>
							<td  style="border-bottom: 2px; border-bottom-color: #d4d5d8; border-bottom-style: inset;">
								${allergiesTO.allergieintruction}
							</td>
							<td  style="border-bottom: 2px; border-bottom-color: #d4d5d8; border-bottom-style: inset;">
								${allergiesTO.dateofallergie}
							</td>
				...
				<center>
					<center>
						...
						<%
							...
							%><a href="./AddAllergies.jsp" class="button-style">Add
							Allergies</a><%} %>
					</center>
				</center>
			</form>
			...
			<tr>
				<td colspan='3'><br><jsp:include page="footer.jsp"></jsp:include><br></td>
			</tr>
		</table>
	</body>
</html>
