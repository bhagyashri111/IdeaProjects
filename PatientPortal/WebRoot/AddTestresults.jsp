		...
		<table>
			...
			<tr>
				...
				<td style="padding-left: 27px;">
					...
					<hr></hr>
					<form action="./AddTestresultsAction" method="post"
						name="testresults" onsubmit='return validate()'>
						<center>
							<h2>
								<font color='#sharew'>Test Results</font>
							</h2>
						</center>
						<pre>
<table align='center'>
        	...
        	<tr>
                ...
                <td align='right'>
                            <input type='text' value='' name='testname'>
                </td>
            </tr>
        	<tr>
                <td align='right'>
        	...
        	<tr>
                ...
                <td align='right' >
                <select name='orderby' style="width: 69%">
...
frmvalidator.addValidation('testdescription', 'req',
		'Please enter testdescription');
