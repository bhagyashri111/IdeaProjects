...
input[type=submit] {
	...
	<body>
		...
		<table>
			...
			<center>
				<h3>
					<font color='#sharew'>Inbox Email</font>
				</h3>
			</center>
			<form action='.\DeleteInboxmailsAction' method='post'>
				<table width="100%">
					...
					<c:forEach var="inboxmailsTO" items="${inboxmailstolist}">
						<tr>
							<td
								style="border-bottom: 2px; border-bottom-color: #d4d5d8; border-bottom-style: inset; text-align:center;">
								<input type='checkbox' name='mailid'
									value='${inboxmailsTO.mailid}'>
							</td>
							...
							<td
								style="border-bottom: 2px; border-bottom-color: #d4d5d8; border-bottom-style: inset;text-align:center;">
								${inboxmailsTO.mailsub}
							</td>
							<td
								style="border-bottom: 2px; border-bottom-color: #d4d5d8; border-bottom-style: inset; text-align:center;">
								${inboxmailsTO.mailbody}
							</td>
							<td
								style="border-bottom: 2px; border-bottom-color: #d4d5d8; border-bottom-style: inset; text-align:center; ">
								${inboxmailsTO.frommailidref}
							</td>
							<td
								style="border-bottom: 2px; border-bottom-color: #d4d5d8; border-bottom-style: inset; text-align:center;">
								${inboxmailsTO.maildate}
							</td>
						</tr>
					</c:forEach>
				</table>
