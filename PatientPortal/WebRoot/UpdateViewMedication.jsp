...
<html>
	...
	<body>
		...
		<div>
			...
			<right-body>
<form action="./UpdateMedicationAction" method="post" name="medication"
onsubmit='return validate()'>
<center>
	<h2>
			<font color='#sharew'>UPDATE MEDICATION</font>
	</h2>
	</center>
	<pre>
	<c:if  test='${medication ne null}'>
<table align='center'>
        	<tr>
                <td align='right'>
        		Useridref :
        	...
        	<tr>
                ...
                <td align='right'>
                            <input type='text' value='${medication.medicationname}' name='medicationname'>
                </td>
            </tr>
        	<tr>
                <td align='right'>
                ...
                <td align='right'>
                            <input type='text' value='${medication.medicationdesc}' name='medicationdesc'>
                </td>
            </tr>
        	<tr>
                <td align='right'>
                ...
                <td align='right'>
                            <input type='text' value='${medication.medicationintruction}' name='medicationintruction'>
                </td>
            </tr>
			        <tr align='center'>
                          <td>
...
var frmvalidator = new Validator("medication");
			frmvalidator.addValidation('medicationid', 'req','Please enter medicationid');
			frmvalidator.addValidation('useridref', 'req','Please enter useridref');
			frmvalidator.addValidation('medicationname', 'req','Please enter medicationname');
			frmvalidator.addValidation('medicationdesc', 'req','Please enter medicationdesc');
			frmvalidator.addValidation('medicationintruction', 'req','Please enter medicationintruction');
			frmvalidator.addValidation('dateofmedication', 'req','Please enter dateofmedication');
