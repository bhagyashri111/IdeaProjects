...
<script type="text/javascript" src="<%=request.getContextPath() + "/js/image.js"%>"> </script>
	...
	<body>
		...
		<div>
			...
			<right-body>
			<form action="./UpdateHealthsummaryAction" method="post"
				name="healthsummary" onsubmit='return validate()'>
				<center>
					<h2>
						<font color='#sharew'>UPDATE HEALTHSUMMARY</font>
					</h2>
				</center>
				<pre>
	<c:if test='${healthsummary ne null}'>
<table align='center'>
        	<tr>
                <td align='right'>
        		Useridref :
        	...
        	<tr>
                ...
                <td align='right'>
                            <input type='text'
										value='${healthsummary.healthissue}' name='healthissue'>
                </td>
            </tr>
			        <tr align='center'>
                          <td>
...
<input type='hidden' name='name'
			...
			<script language='JavaScript' type='text/javascript'>
var frmvalidator = new Validator("healthsummary");
frmvalidator
		.addValidation('healthissueid', 'req', 'Please enter healthissueid');
frmvalidator.addValidation('useridref', 'req', 'Please enter useridref');
frmvalidator.addValidation('healthissue', 'req', 'Please enter healthissue');
frmvalidator.addValidation('dateofnote', 'req', 'Please enter dateofnote');
