...
import DaoInterface.CoonectionDao;
import model.Books;
...
public class BookDaoImpl extends CoonectionDao implements BookDao {
    public void saveBook(List<Books> BookList) {
        try {
            Connection con = CoonectionDao.getConnection();
    ...
    public List<Books> getAllBooks() {
        try {
            Connection connection = CoonectionDao.getConnection();
